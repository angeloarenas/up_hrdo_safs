#App Process DSF Test

require 'watir'
browser = Watir::Browser.new :chrome
browser.goto 'http://[::1]/HRDO_SAFS/apply/doctoralstudies'

#Obligations and Conditions
print "Testing Obligations and Conditions:\n\n"  

browser.div(:text => 'Type').click
if browser.text.include?("Local Faculty Fellowship and Foreign Faculty Fellowship")
	print "Type PASSED\n"
else
	print "Type FAILED\n"
end
...
browser.div(:text => 'Identification of Discipline').click
if browser.text.include?("To determine the key areas of development")
	print "Identification of Discipline PASSED\n"
else
	print "Identification of Discipline FAILED\n"
end
browser.div(:text => 'Identification of Discipline').click
...
#Application Process
print "Testing DSF Application Process:\n\n"
