...
<head>
  ...
  <!-- Site Properties -->
  <title>Employee - HRDO Sabbatical Manager</title>
  ...
  <link href="https://cdn.datatables.net/responsive/2.1.1/css/responsive.semanticui.min.css" rel="stylesheet">
...
<div class="pusher">
  <h1 class="ui header"><i class="database icon"></i>Employee List</h1>
  <hr>
  ...
  <h4>Contact Sureties</h4>
  <div class="ui one column doubling stackable grid container">
    <div class="column">
      <table class="ui four column very basic compact celled table">
        <tbody>
          <tr>
            <td class="active"><center><b>Name</b></center></td>
            <td class="active"><center><b>Address</b></center></td>
            <td class="active"><center><b>Contact No.</b></center></td>
            <td class="active"><center><b>E-mail Address</b></center></td>
          </tr>
          ...
          <tr>
            ...
            <td><center>'.$item['contactno'].'</center></td>
  ...
  <div class="ui four column doubling stackable grid container">
    ...
    <div class="column">
      <div class="ui fluid negative button" id="delete_employee_button">
        <i class="remove icon"></i>
        Delete Employee
        <div id="delete_employee_modal" class="ui small modal">
          <div class="header">
            <i class="remove icon"></i>Delete Employee
          </div>
          <div class="content">
          ...
          <div class="actions">
            ...
            <div id="delete_employee" type="submit" class="ui positive button">
              Delete
            </div>
          </div>
        </div>
    ...
    <div class="column">
      <div class="ui fluid positive button" id="edit_employee_button">
        <i class="edit icon"></i>
        Edit Employee
        <div id="edit_employee_modal" class="ui long small modal">
          <div class="header">
            <i class="edit icon"></i>Edit Employee
          </div>
          <div class="content">
            <form class="ui form" id="edit_employee_form">
              ...
              <div class="fields">
                ...
                <div class="four wide required field">
                  ...
                  <input id="lastname" type="text" name="employee_ln" placeholder="Last Name" value="<?php echo $employee_data['lastname']; ?>">
                </div>
                <div class="four wide required field">
                  <label>First Name</label>
                  <input id="firstname" type="text" name="employee_fn" placeholder="First Name" value="<?php echo $employee_data['firstname']; ?>">
                </div>
                <div class="two wide field">
                  <label>Suffix</label>
                  <input id="suffix" type="text" name="employee_s" placeholder="Suffix"  value="<?php echo $employee_data['suffix']; ?>">
                </div>
                <div class="three wide required field">
                  <label>Middle Name</label>
                  <input id="middlename" type="text" name="employee_mn" placeholder="Middle Name"  value="<?php echo $employee_data['middlename']; ?>">
                </div>
              </div>
              <div class="two required fields">
                <div class="field">
                  ...
                  <?php
                    $empbirthday = DateTime::createFromFormat('Y-m-d', $employee_data['birthdate']);
                    $empbirthday_1 = $empbirthday->format('m/d/Y');
                  ?>
                  <input id="birthdate" type="text" name="date_of_birth" maxlength="10" value="<?php echo $empbirthday_1; ?>">
                </div>
                <div class="required field">
                  <label>Gender</label>
                  <div class="ui selection dropdown">
                    <i class="dropdown icon"></i>
                    <input id="gender" type="hidden" value = "<?php echo $employee_data['gender']; ?>" name="gender">
                    <div class="text" id="gender_text"><?php echo $employee_data['gender']; ?></div>
                    <div class="menu">
              ...
              <div class="two fields">
                <div class="required field">
                  ...
                  <input id="primaryemail" type="text" name="primary_email" value="<?php echo $employee_data['primaryemail']; ?>">
                </div>
                <div class="field">
                  <label>Secondary E-Mail Address</label>
                  <input id="secondaryemail" type="text" name="secondary_email" value="<?php echo $employee_data['secondaryemail']; ?>">
                </div>
              </div>
              <div class="two fields">
                <div class="required field">
                  <label>Primary Contact No.</label>
                  <input id="primarycontact" type="text" name="primary_contact_no" maxlength="11" value="<?php echo $employee_data['primarycontact']; ?>">
                </div>
                <div class="field">
                  <label>Secondary Contact No.</label>
                  <input id="secondarycontact" type="text" name="secondary_contact_no" maxlength="11" value="<?php echo $employee_data['secondarycontact']; ?>">
                </div>
              </div>
              <div class="required field">
                <label>Permanent Address</label>
                <input id="permanentaddress" type="text" name="permanent_address" value="<?php echo $employee_data['permanentaddress']; ?>">
              </div>
              <div class="two required fields">
                <div class="field">
                  <label>Unit</label>
                  <div class="ui search selection dropdown">
                    <i class="dropdown icon"></i>
                    <input id="unit" type="hidden" value="<?php echo $employee_data['unit']; ?>" name="unit">
                    <div class="text" id="unit_text"><?php echo $employee_data['unit']; ?></div>
                    <div class="menu">
                ...
                <div class="field">
                  ...
                  <div class="ui search selection dropdown">
                    <i class="dropdown icon"></i>
                    <input id="department" type="hidden" value="<?php echo $employee_data['department']; ?>" name="department">
                    <div class="text" id="department_text"><?php echo $employee_data['department']; ?></div>
                    <div class="menu">
                      <div class="item" data-value="AC">AC</div>
              ...
              <div class="two required fields">
                <div class="field">
                  ...
                  <div class="ui selection dropdown">
                    <i class="dropdown icon"></i>
                    <input id="employeetype" type="hidden" value="<?php echo $employee_data['employeetype']; ?>" name="employee_type">
                    <div class="text" id="employee_text"><?php echo $employee_data['employeetype']; ?></div>
                    <div class="menu">
                ...
                <div class="field">
                  ...
                  <div class="ui search selection dropdown">
                  <i class="dropdown icon"></i>
                  <input id="employmentstatus" type="hidden" value="<?php echo $employee_data['employmentstatus']; ?>" name="employment_status">
                  <div class="text" id="status_text"><?php echo $employee_data['employmentstatus']; ?>"</div>
                  <div class="menu">
              ...
              <div class="two required fields">
                <div class="field">
                  ...
                  <div class="ui search selection dropdown">
                    <i class="dropdown icon"></i>
                    <input id="rank" type="hidden" value="<?php echo $employee_data['rank']; ?>" name="rank">
                    <div class="text" id="rank_text"><?php echo $employee_data['rank']; ?></div>
                    <div class="menu">
                ...
                <div class="field">
                  ...
                  <?php
                      $empoa = DateTime::createFromFormat('Y-m-d', $employee_data['originalassignment']);
                      $empoa_1 = $empoa->format('m/d/Y');
                   ?>
                  <input id="originalassignment" type="text" name="original_assignment" maxlength="10" value="<?php echo $empoa_1 ?>">
                </div>
              </div>
              ...
              <?php for ($i = 1; $i <= $contacts_count; $i++) : ?>
              <?php echo'
              <div class="four fields">
                <div class="field">
                  <input id="cs'.$i.'_name" type="text" value="'.$contacts_list[$i-1]['name'].'" name="cs'.$i.'_name" placeholder="CS 1 LN, FN, S, MN">
                </div>
                <div class="field">
                  <input id ="cs'.$i.'_address" type="text" value="'.$contacts_list[$i-1]['address'].'" name="cs'.$i.'_address" placeholder="CS 1 Address">
                </div>
                <div class="field">
                  <input id="cs'.$i.'_contact_no" type="text" value="'.$contacts_list[$i-1]['contactno'].'" name="cs'.$i.'_contact_no" placeholder="CS 1 Contact No.">
                </div>
                <div class="field">
                  <input id="cs'.$i.'_email"  type="text" value="'.$contacts_list[$i-1]['email'].'" name="cs'.$i.'_email" placeholder="CS 1 E-Mail Address">
                </div>
              </div>
              '; ?>
              <?php endfor; ?>
              ...
              <div class="four fields">
                <div class="field">
                  <input id="cs'.$j.'_name" type="text" value="" name="cs'.$j.'_name" placeholder="CS '.$j.' LN, FN, S, MN">
                </div>
                <div class="field">
                  <input id ="cs'.$j.'_address" type="text" value="" name="cs'.$j.'_address" placeholder="CS '.$j.' Address">
                </div>
                <div class="field">
                  <input id="cs'.$j.'_contact_no" type="text" value="" name="cs'.$j.'_contact_no" placeholder="CS '.$j.' Contact No.">
                </div>
                <div class="field">
                  <input id="cs'.$j.'_email"  type="text" value="" name="cs'.$j.'_email" placeholder="CS '.$j.' E-Mail Address">
                </div>
              </div>
              '; ?>
              <?php endfor; ?>
          ...
          <div class="actions">
            ...
            <button id="save_edit_employee" class="ui green submit button" type="submit" form="edit_employee_form">Save</button>
          </div>
        </div>
      </div>
    </div>
...
// for triggering modals when button clicked
  $('#edit_employee_modal').modal('attach events', '#edit_employee_button', 'show').modal('setting', 'closable', false);
  $('#delete_employee_modal').modal('attach events', '#delete_employee_button', 'show').modal('setting', 'closable', false);
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal( {
              header: function ( row ) {
                  var data = row.data();
                  return 'Details for Transaction No. '+data[0]+'; '+data[1];
              }
          } ),
  ...
  $(function(){
          $( "#delete_employee" ).click(function(event)
          {
              ...
              var employeenumber= String("<?php echo $employee_data['employeenumber']; ?>");
              $.ajax(
                  {
                      type:"post",
                      url: "<?php echo base_url(); ?>/Admin/delete_employee",//URL changed
                      data:{
                      ...
                      {
                          //console.log(data);
                          window.location.href = '<?php echo base_url() ?>admin/employeelist';
                      }
                  });
          });
      });
      ...
      $(function(){
              $( "#save_edit_employee" ).click(function(event)
              {
                  event.preventDefault();//prevent auto submit data
                  var originalemployeenumber = String("<?php echo $employee_data['employeenumber']; ?>");
                  ...
                  if(emplchar && employeenumber.length == 9 && lastname && firstname && middlename && birthdate && primaryemail && primarycontact && permanentaddress && originalassignment){
                    $.ajax(
                        {
                            type:"post",
                            url: "<?php echo base_url(); ?>/Admin/update_employee",//URL changed
                            data:{
                              originalemployeenumber:originalemployeenumber,
                              employeenumber:employeenumber,
                              lastname:lastname,
                              firstname:firstname,
                              suffix:suffix,
                            ...
                            {
                                //console.log(data);
                                window.location.href = '<?php echo base_url() ?>admin/employeelist/' + employeenumber;
                            },
