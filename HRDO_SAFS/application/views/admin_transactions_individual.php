...
<head>
  ...
  <!-- Site Properties -->
  <title>Transaction - HRDO Sabbatical Manager</title>
...
<div class="pusher">
  ...
  <div class="ui two column doubling stackable grid container">
    <div class="column">
      <table class="ui two column very basic compact table">
        <tbody>
          <tr>
            <td id="left" class="active right aligned"><b>Transaction No.:</b></td>
  ...
  <div class="ui four column doubling stackable grid container">
    ...
    <div class="column">
      <div class="ui fluid negative button" id="delete_transaction_button">
        <i class="remove icon"></i>
        Delete Transaction
        <div id="delete_transaction_modal" class="ui small modal">
          <div class="header">
            <i class="remove icon"></i>Delete Transaction
          </div>
          <div class="content">
          ...
          <div class="actions">
            ...
            <div id="delete_transaction" type="submit" class="ui positive button">
              Delete
            </div>
          </div>
        </div>
    ...
    <div class="column">
      <div class="ui fluid positive button" id="edit_transaction_button">
        <i class="edit icon"></i>
        Edit Transaction
        <div id="edit_transaction_modal" class="ui long small modal">
          <div class="header">
            <i class="edit icon"></i>Edit Transaction
          </div>
          <div class="content">
          	<form id="edit_transaction_form" class="ui form">
              <h4 class="ui dividing header">Transaction Information</h4>
              <div class="three fields">
                <div class="required field">
                  <label>Transaction No.</label>
                  <input id="transactionnumber" type="text" name="transaction_no" maxlength="7" placeholder="1234567" value="<?php echo $transaction_data['transactionnumber']; ?>">
                </div>
                <div class="field">
                  <label>Employee No.</label>
                  <input type="text" disabled="disabled" readonly="readonly" name="employee_no" maxlength="9" placeholder="123456789" value="<?php echo $employee_data['employeenumber']; ?>">
                </div>
                <div class="field">
                  <label>Application Date</label>
                  <?php $applicationdate = date("m/d/Y", strtotime($transaction_data['applicationdate']));?>
                  <input type="text" disabled="disabled" readonly="readonly" name="application_date" maxlength="10" placeholder="mm/dd/yyyy" value="<?php echo $applicationdate; ?>">
                </div>
              </div>
              <div class="three required fields">
                  ...
                  <div class="ui selection dropdown">
                    <input id="leavetype" type="hidden" value="<?php echo $transaction_data['leavetype']; ?>" name="leave_type">
                ...
                <div class="field">
                  ...
                  <div class="ui selection dropdown">
                    <input id="leavedetails" type="hidden" value="<?php echo $transaction_data['leavedetails']; ?>" name="leave_details">
                    <i class="dropdown icon"></i>
                ...
                <div class="field">
                  ...
                  <div class="ui selection dropdown">
                    <input id="leavestatus" type="hidden" value="<?php echo $transaction_data['leavestatus']; ?>" name="leave_status">
                    <i class="dropdown icon"></i>
              ...
              <div class="three required fields">
                <div class="field">
                  ...
                  <div class="ui selection dropdown">
                    <input id="developmenttype" type="hidden" value="<?php echo $transaction_data['developmenttype']; ?>" name="development_type">
                    <i class="dropdown icon"></i>
                ...
                <div class="field">
                  ...
                  <input id="degreepursued" type="text" name="degree_pursued" value="<?php echo $transaction_data['degreepursued']; ?>">
                </div>
                <div class="field">
                  <label>Institution</label>
                  <input id="institution" type="text" name="institution" value="<?php echo $transaction_data['institution']; ?>">
                </div>
              </div>
              <div class="two required fields">
    	          <div class="field">
    	            <label>Location</label>
                  <input id="location" type="text" name="location" value="<?php echo $transaction_data['location']; ?>">
    	          </div>
    	          <div class="field">
    	            <label>Country</label>
    	            <div class="ui search selection dropdown" id="country_text">
    				        <input id="country" type="hidden" value="<?php echo $transaction_data['country']; ?>" name="country">
    				        <i class="dropdown icon"></i>
    			          <div class="text">
                ...
                <div class="field">
                  ...
                  <!--<div class="ui selection dropdown">
                    <input id="sponsordonor" PHP ECHO VALUE type="hidden" name="sponsorORdonor">
                    <i class="dropdown icon"></i>
                ...
                <div class="required field">
                  ...
                  <div class="ui selection dropdown">
                    <input id="localabroad" value="<?php echo $transaction_data['localabroad']; ?>" type="hidden" name="localORabroad">
                    <i class="dropdown icon"></i>
              ...
              <div class="two required fields">
                <div class="field">
                  ...
                  <?php $startdate = date("m/d/Y", strtotime($transaction_data['startdate']));?>
                  <input id="startdate" type="text" name="start_date" maxlength="10" value="<?php echo $startdate; ?>">
                </div>
                <div class="field">
                  <label>End Date</label>
                  <?php $enddate = date("m/d/Y", strtotime($transaction_data['enddate']));?>
                  <input id="enddate" type="text" name="end_date" maxlength="10" value="<?php echo $enddate; ?>">
                </div>
              </div>
              <div class="two required fields">
                <div class="field">
                  <label>Duration</label>
                  <input id="duration" type="text" name="duration" value="<?php echo $transaction_data['duration']; ?>">
                </div>
                <div class="field">
                  <label>Report For Duty</label>
                  <?php $reportforduty = date("m/d/Y", strtotime($transaction_data['enddate']));?>
                  <input id="reportforduty" type="text" name="report_for_duty" maxlength="10" value="<?php echo $reportforduty; ?>">
                </div>
              </div>
              <div class="two required fields">
                <div class="field">
                  <label>Return Service Obligation</label>
                  <input id="rso" type="text" name="return_service_obligation" value="<?php echo $transaction_data['rso']; ?>">
                </div>
                <div class="field">
                  ...
                  <div class="ui selection dropdown">
                    ...
                    <div class="menu">
                        <div class="item" data-value="S">Served</div>
                        <div class="item" data-value="US">Unserved</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="actions">
            ...
            <button id="save_edit_transaction" class="ui green submit button" type="submit" form="edit_transaction_form">Save</button>
          </div>
        </div>
      </div>
    </div>
...
// for triggering modals when button clicked
  $('#edit_transaction_modal').modal('attach events', '#edit_transaction_button', 'show').modal('setting', 'closable', false);
  $('#delete_transaction_modal').modal('attach events', '#delete_transaction_button', 'show').modal('setting', 'closable', false);
  ...
  $(function(){
          $( "#save_edit_transaction" ).click(function(event)
          {
              ...
              if(transactionnumber.length == 7 && transchar && degreepursued && institution && location && startdate && enddate && duration && reportforduty && rso){
                $.ajax(
                    {
                        type:"post",
                        url: "<?php echo base_url(); ?>/Admin/update_transaction",//URL changed
                        data:{
  ...
  $(function(){
          $( "#delete_transaction" ).click(function(event)
          {
              ...
              $.ajax(
                  {
                      type:"post",
                      url: "<?php echo base_url(); ?>/Admin/delete_transaction",//URL changed
                      data:{
                        transactionnumber:transactionnumber,
                        '<?php echo $this->security->get_csrf_token_name(); ?>':'<?php echo $this->security->get_csrf_hash(); ?>'
                      },
                      ...
                      {
                          //console.log(data);
                          window.location.href = '<?php echo base_url() ?>admin/transactionslist';
                      }
                  });
          });
      });
