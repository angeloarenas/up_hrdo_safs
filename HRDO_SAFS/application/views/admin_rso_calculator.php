...
?>
<html>
  <!--PROGRAMMER IMPORTED SCRIPTS-->
  <script src="<?php echo base_url('assets/js/calculator/jquery/jquery-2.1.4.min.js'); ?>"></script>
...
<div class="ui vertical left visible sidebar menu">
  ...
  <a href="<?php echo base_url(); ?>admin/rsocalculator" class="side item active" id="calc">
...
<!--Calculator-->
<div class="pusher">
  <h1 id="header"><i class="calculator icon"></i>RSO Calculator</h1>
  <hr>
